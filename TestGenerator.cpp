...
void generateTests() {
    ...
    std::vector<std::string> operacje = {"push_back", "push_front", "insert", "remove_back", "remove_front", "remove", "get", "search"};

    file << "nr.,rozmiar,operacja,dynamiczna,jednokierunkowa,dwukierunkowa\n";
